...
import { createMonitor } from "@/app/api/actions"
...
export default function NewMonitor() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createMonitor(formDataObj)
      router.push("/")
    } catch (err) {
      setError(err instanceof Error ? err.message : "Error al crear el monitor")
    } finally {
  ...
  return (
    <div className="container py-10 max-w-2xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-3xl font-bold tracking-tight">Nuevo Monitor</h1>
      </div>
      ...
      <Card>
        <form onSubmit={handleSubmit}>
          <CardHeader>
            ...
            <CardDescription>Introduce los detalles del servicio que deseas monitorizar</CardDescription>
          </CardHeader>
